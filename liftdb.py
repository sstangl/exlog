...
liftdb = {
    ...
    "202 tempo squat": LiftType.squat,
    "210 tempo squat": LiftType.squat,
    "303 tempo leg press": LiftType.squat,
    "303 tempo squat": LiftType.squat,
    "321 tempo squat": LiftType.squat,
    ...
    "2-count paused chest-supported row": LiftType.bench,
    ...
    "chain close-grip bench": LiftType.bench,
    ...
    "seated cable row": LiftType.bench,
    ...
    "rear delt row": LiftType.conditioning,
